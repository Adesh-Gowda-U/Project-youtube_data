...
## @type: DataSource
## @args: [database = "project3-youtube-raw", table_name = "raw_statistics", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []

datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "project3-youtube-raw", table_name = "raw_statistics", transformation_ctx = "datasource0")
## @type: ApplyMapping
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://adesh-project-3-cleaned-dat/youtube/cleaned_statistics"}, format = "parquet", transformation_ctx = "datasink4"]
## @return: datasink4
## @inputs: [frame = dropnullfields3]

datasink1 = dropnullfields3.toDF().coalesce(1)
df_final_output = DynamicFrame.fromDF(datasink1, glueContext, "df_final_output")
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": "s3://adesh-project-3-cleaned-dat/youtube/cleaned_statistics", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
job.commit()